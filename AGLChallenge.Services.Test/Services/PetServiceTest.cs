...
namespace AGLChallenge.Services.Test.Services
{
    public class PetServiceTest
    {
        ...
        public async Task GetCatByOwnerGenderTest(string filePath, int count, params string[] expectedFirstResult)
        {
        ...
        public async Task GetPetsGenericType(string filePath, string filter, params string[] expectedFirstResult)
        {
            var petService = CreateTestService(filePath);
